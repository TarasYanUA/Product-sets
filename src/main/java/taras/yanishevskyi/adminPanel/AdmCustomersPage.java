...
public class AdmCustomersPage extends AbstractPage {
    ...
    @FindBy(css = "tr[data-ca-id=\"10\"] a[class='btn dropdown-toggle']")
    private WebElement gearwheelOfSimtechVendor;
    ...
    public WebElement hoverGearwheelOfSimtechVendor(){return gearwheelOfSimtechVendor;}
    public void navigateToGearwheelOfSimtechVendor(){
        WebElement element = hoverGearwheelOfSimtechVendor();
        Actions hoverGearwheelOfSimtechVendor = new Actions(DriverProvider.getDriver());
        hoverGearwheelOfSimtechVendor.moveToElement(element);
        hoverGearwheelOfSimtechVendor.perform();
        gearwheelOfSimtechVendor.click();
    }
